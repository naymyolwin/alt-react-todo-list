...
class ToDoList extends React.Component {
  ...
  handleSubmit(event) {
    ...
    fetch("https://fewd-todolist-api.onrender.com/tasks?api_key=107", {
      method: "POST",
      mode: "cors",
  ...
  deleteTask(id) {
    ...
    fetch(`https://fewd-todolist-api.onrender.com/tasks/${id}?api_key=107`, {
      method: "DELETE",
      mode: "cors",
    })
      .then(checkStatus)
  ...
  toggleComplete(id, completed) {
    ...
    fetch(
      `https://fewd-todolist-api.onrender.com/tasks/${id}/mark_${newState}?api_key=107`,
      {
        method: "PUT",
        mode: "cors",
      }
